    ...
    return (
        ...
        <Grid container spacing={3}>
            <Grid item xs={12}>
                ...
                <Typography variant="button" display="block" gutterBottom>Ressources</Typography>
                      <CardRessource data={module} token={token} />
                    </Grid>
                    <Grid item lg={4} md={12} sm={12} xs={12}>
                    <CardCorrection data={listeExam} token={token} handleUpdate={handleUpdate} />
                    </Grid>
                    <Grid item lg={4} md={12} sm={12} xs={12}>
                    <Typography variant="button" display="block" gutterBottom>Groupes</Typography>
...
export default function AdminContent({module,token,type}){
    ...
    if(module != undefined && listRessource!= undefined ){
        return <GetModuleAdmin module={module} token={token} listRessource={listRessource} listeExam={listeExam} handleUpdate={handleUpdate}/>
