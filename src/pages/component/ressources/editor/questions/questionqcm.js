...
export default function QuestionQCM (props) {
    ...
    return (
        <Accordion>
                ...
                >
                  <Typography>{props.props.index+"# Question QCM :"}</Typography> 
                ...
                <TextField
                 ...
                 style={{"margin-left": "100px", Width:"80%" }}
                    ...
                    onChange={props.props.handle(props.props.index,question,"onchange","choix")}
                    InputProps={{
                      startAdornment: (
                        <InputAdornment position="start">
                          <HelpOutlineIcon />
                 ...
                 style={{"margin-left": "100px", Width:"80%" }}
                    id="input-with-icon-textfield"
                    label={"Réponses justes(séparées par des §)"}
