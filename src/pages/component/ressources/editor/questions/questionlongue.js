...
export default function QuestionLongue (props) {
    ...
    return (
        <Accordion>
                ...
                >
                  <Typography>{props.props.index+"# Question Longue :"}</Typography> 
                ...
                <DragAndDrop handleDrop={handleDrop} id="r">
                <TextareaAutosize onFocus={props.props.handleLastFocus([question,"reponse",updateMedia])} id="reponse" value={question.reponse} style={{ 'width': '100%', 'height':200}} onChange={props.props.handle(props.props.index,question,"onchange","reponse")} />
                </DragAndDrop>
                  <TextField
                  fullWidth
                  ...
                  <Box
                    ...
                    >
                      ...
                      />
                     <FormControlLabel sx={{ ml: 2 }}   control={<Checkbox checked={question.Requis} onChange={props.props.handle(props.props.index,question,"onchange","Requis")}/>} label="Requis" />
